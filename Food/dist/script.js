...
function calc() {
  ...
  function calcTotal() {
    ...
    if (result.textContent > 4000) {
      result.textContent = '<(0_0)/ много!';
...
function form(formSelector, modalTimerId) {
  ...
  function bindpostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:4000/requests', json).then(data => {
        console.log(data);
  ...
  fetch('http://localhost:4000/menu').then(data => data.json()).then(res => console.log(res));
}
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  }); // (tabsSelector.slice(1)) - обрезает первый знак и начинает со второго и получается tabheader__item из script.js
}
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 2000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-05-25');
